				...
				<div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="ServiceForm.php" class="btn btn-defualt"> Add New</a>
                        </div>
                        <div class="card-body">
...
<td style="text-align:center;"><?php  echo $row["Created_On"]?>
                                                ...
                                                <td style="text-align:center;"><a href="ServiceForm.php?edit_id=<?php echo $row["Id"] ?>"><img src="images/edite.png" width="30" height="30" /></a></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
