                            ...
                            <table class="table table-bordered">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col"  style="background-color:#000;color:#FFF; text-align:center;">Message</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Email</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Number</th>
                                  <th scope="col"  style="background-color:#000;color:#FFF;text-align:center;">Subject</th>
                              ...
                              <tbody>
                                 <?php
									...
									$query = mysqli_query($connection,"SELECT * FROM contactmsgs where Is_Responded = 0
order by Created_On desc;");
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align:center;"><?php  echo $row["Msg"]?></td>
...
<td style="text-align:center;"><?php  echo $row["Created_On"]?>
                                                ...
                                                <td style="text-align:center;"><a href="ContactUsForm.php?edit_id=<?php echo $row["Id"] ?>"><img src="images/edite.png" width="30" height="30" /></a></td>                                     
                                        </tr>                                   
                                    </tbody>
                                    <?php
