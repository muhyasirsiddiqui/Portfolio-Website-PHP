...
<div class="dl-caption medium"><div class="inner-layer"><div data-animation="fade-in-right" data-delay="1s">Arn Group</div></div></div>
<div class="dl-caption big"><div class="inner-layer"><div data-animation="fade-in-left" data-delay="2s">Anwar & Rehmet Enterprises LLC</div></div>
</div>
<div class="dl-caption big"><div class="inner-layer"><div data-animation="fade-in-left" data-delay="2.5s">Subsidiary: Nadir Trading & Transport</div></div></div>
<div class="dl-caption small"><div class="inner-layer"><div data-animation="fade-in-left" data-delay="3s"><br></div></div></div>
<div class="dl-btn-group">
<div class="inner-layer">
<a href="projects.php" class="dl-btn" data-animation="fade-in-left" data-delay="3.5s">View Projects <i class="arrow_right"></i></a>
</div>
</div>
</div>
</div>
...
<div class="container">
<div class="slider-content">
<div class="dl-caption medium"><div class="inner-layer"><div data-animation="fade-in-top" data-delay="1s">Arn Group</div></div></div>
...
<div class="dl-caption small"><div class="inner-layer"><div data-animation="fade-in-bottom" data-delay="3s">We have provided complete remodeling and construction solutions for <br>residential and commercial properties in Oman.</div></div></div>
<div class="dl-btn-group">
<div class="inner-layer">
<a href="projects.php" class="dl-btn" data-animation="fade-in-bottom" data-delay="3.5s">View Projects <i class="arrow_right"></i></a>
</div>
</div>
</div>
</div>
...
<div class="dl-caption small"><div class="inner-layer"><div data-animation="fade-in-right" data-delay="3s">We have provided complete remodeling and construction solutions for <br>residential and commercial properties in Oman.</div></div></div>
<div class="dl-btn-group">
<div class="inner-layer">
<a href="projects.php" class="dl-btn" data-animation="fade-in-right" data-delay="3.5s">View Projects <i class="arrow_right"></i></a>
</div>
</div>
</div>
</div>
...
<h2>We are the expert in this field since 1992.</h2>
<p>We are committed to building a sustainable future by fostering a collaborative spirit that creates exceptional experiences, balanced relationships, and community built environment. Building isn’t just job. It's our passion. With every project we undertake, we set the bar high and provide the best to the construction industry.</p>
<a href="about-us.php" class="default-btn">More About Us</a>
</div>
</div>
<div class="col-lg-6 sm-padding">
...
<p>We believe in satisfying our clients with the fulfillment of their requirements. 
    The client is more important to us than the business</p>
</div>
</li>
...
<p>We provide best customer experiences to the clients. We do not compromise on quality and services. 
</p>
</div>
</li>
</ul>
...
<span>Services</span>
<h2>Take the Oman’s best <br> services for you</h2>
</div>
<div class="container">
<div class="row">
...
<p>We have a team of professionals who are responsible to develop a solid plan before project's execution.</p>
</div>
</div>
<div class="col-lg-3 col-sm-6 sm-padding">
<div class="work-pro-item text-center">
...
<div class="number-line"></div>
<h3>Design & Ideas</h3>
<p>We have creative team of designers who are up to date with the market trends. We follow latest designs in our constructions.</p>
</div>
</div>
<div class="col-lg-3 col-sm-6 sm-padding">
<div class="work-pro-item text-center">
...
<p>We have been delivering several projects for the government, organizations and to the individuals.</p>
</div>
</div>
<div class="col-lg-3 col-sm-6 sm-padding">
<div class="work-pro-item text-center">
...
<h3>Final Outputs</h3>
<p>If you are looking for the Oman's best construction company. You are surely at the right place. Contact us now!</p>
</div>
</div>
</div>
</div>
...
<a href="projects.php" class="default-btn">View All Projects</a>
</div>
</div>
...
<a href="#" class="default-btn wow fadeInUp" data-wow-delay="500ms"></a>
</div>
</div>
</div>
