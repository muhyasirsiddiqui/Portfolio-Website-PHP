...
<div class="row project-single-wrap align-items-center">
 ...
 <?php 	
				...
				$p_name = $_GET["btn_id"];		
				$display = "SELECT projects.Img_URL_1,projects.Img_URL_2,projects.Img_URL_3,projects.Img_URL_4,projects.Name as PName,category.Name,projects.Description,projects.Summary from projects 
				inner join category on projects.Category_Id = category.Id where projects.Id='".$p_name."'";
...
<div class="single-carousel">
<img src="Admin_Pages/images/<?php echo $row["Img_URL_3"]?>" alt="img" style="height: 650px;">
</div>
<div class="single-carousel">
<img src="Admin_Pages/images/<?php echo $row["Img_URL_4"]?>" alt="img" style="height: 650px;">
</div>
</div>
</div>
<div class="col-md-6 sm-padding">
...
<li><span>Summary</span><?php echo $row["Summary"]?></li>
