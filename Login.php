...
<body style="background-image:url(img/project-s-3.jpg); background-repeat:no-repeat; background-size:cover; background-attachment:fixed;">
<!-------Login-------->
...
if(isset($_POST["btn_login"]))
{
	...
	$query = mysqli_query($connection,"select * from users where Name ='".$user_name."' AND Expiry_Date > CURRENT_DATE ");
...
<!-------End Login-------->
	<div class="w3ls-headding">
		<h1><span>T</span>he<span> A</span>RN <span>L</span>ogin <span>F</span>orm</h1>
	</div>
	<div class="agile-main">
		<div class="agile-left">
				<img src="img/PDODOMEMAF.jpeg" width="200" height="350" />
		</div>
...
/>
				...
				<div class="w3l-submit">
					<span style="color:red; text-align:center;"> <?php if(isset($_POST["btn_login"])) echo $result ?> </span>
				</div>
