       ...
       <!----------****Edit Action Start****-------------->
        ...
        <?php
				 ...
				 if(isset($_GET["edit_id"]))			 
				{
					...
					$edit = $_GET["edit_id"];
					$tbl_query = mysqli_query($connection,"select * from category_table where Cat_Id= '".$edit."'");
					$row = mysqli_fetch_array($tbl_query);
					$cat_id = $row["Cat_Id"];
 ...
 <?php
						...
						if(isset($_POST["btn_insert"]))
						{
						 include("config.php");
							...
							{
							$mycatid = $_POST["hideid"];
							$query= mysqli_query($connection,"update category_table set Cat_Name = '".$category_name."' where Cat_Id='".$mycatid."'");
							if($query)
							{
							...
							{
							$query= mysqli_query($connection,"insert into category_table (Cat_Name) values ('".$category_name."')");
							if($query)
							{
...
<!---****Insert Action End****--->
                    ...
                    <div class="card">
                      ...
                      <form method="post" action="Add_Category.php">
                        ...
                        <input type="hidden" name="hideid" class="form-control" value="<?php echo @$cat_id ?>"/>
                        </div>
                        <div class="form-group"><label class=" form-control-label"><b>Enter Your Category Name</b></label>
                        <input type="text" name="cate_name" placeholder="Enter Your Category Name" class="form-control" value="<?php echo @$cat_name ?>"/>
                        </div>    
                        ...
                        <div class="form-group"><label style="margin-left:20px; color:#F00;"><?php if(isset($_POST["btn_insert"])) echo $result ?></label>
